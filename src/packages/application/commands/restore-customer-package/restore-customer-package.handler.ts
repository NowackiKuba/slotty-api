...
import { RestoreCustomerPackageCommand } from './restore-customer-package.command';

@CommandHandler(RestoreCustomerPackageCommand)
export class RestoreCustomerPackageHandler implements ICommandHandler<
  RestoreCustomerPackageCommand,
...
> {
  ...
  async execute(
    command: RestoreCustomerPackageCommand,
