...
import { MarkCustomerPackagePaidCommand } from './mark-customer-package-paid.command';

@CommandHandler(MarkCustomerPackagePaidCommand)
export class MarkCustomerPackagePaidHandler implements ICommandHandler<
  MarkCustomerPackagePaidCommand,
...
> {
  ...
  async execute(
    command: MarkCustomerPackagePaidCommand,
