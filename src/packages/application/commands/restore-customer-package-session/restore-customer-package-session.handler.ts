...
import { RestoreCustomerPackageSessionCommand } from './restore-customer-package-session.command';

@CommandHandler(RestoreCustomerPackageSessionCommand)
export class RestoreCustomerPackageSessionHandler implements ICommandHandler<
  RestoreCustomerPackageSessionCommand,
...
> {
  ...
  async execute(
    command: RestoreCustomerPackageSessionCommand,
    ...
    customerPackage.restoreSession();
