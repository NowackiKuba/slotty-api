...
import { RevokeUserIntegrationCommand } from './revoke-user-integration.command';

@CommandHandler(RevokeUserIntegrationCommand)
export class RevokeUserIntegrationHandler implements ICommandHandler<
  RevokeUserIntegrationCommand,
...
> {
  ...
  async execute(
    command: RevokeUserIntegrationCommand,
